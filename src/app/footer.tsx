...
export default function Footer() {
  return (
    <>
      <footer className="w-full bg-slate-900 dark:bg-gray-900 py-16 ">
        <div className="md:px-12 lg:px-28">
          <div className="container mx-auto space-y-6 text-gray-600 dark:text-gray-300">
            <div className=" grid justify-items-stretch">
              <Image
                className="hover:animate-[spin_6s_linear_infinite] justify-self-center "
                src={LogoPNG}
                alt="Logo"
                width={60}
                height={60}
            ...
            <div className="text-center">
              <span className="text-sm tracking-wide">
                Copyright © Poseidon <span id="year"></span> | All right
                reserved
              </span>
            </div>
          </div>
